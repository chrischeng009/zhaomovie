<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"/www/wwwroot/movie/applications/index/view/common/common.html";i:1586957861;}*/ ?>
              ...
              <?php }if(session('power')=='0'){?>          
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="<?php echo url('mn/index'); ?>">影院热门</a></dd>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                       ...
                       <?php if(session('power')=='0'){?>
                        <dd><a href="<?php echo url('user/index'); ?>">代理管理</a></dd>
    ...
    function money(status,id){
        ...
        layer.prompt({title: '请输入充值点数', formType: 3}, function(pass, index) {
            if(!isNaN(pass))
            {
                ...
                window.location.href='http://xxxxxx.com/daili_pay/?id='+id+'&name=代理自助充点&fee='+pass;
                layer.close(index);
            }else{
