<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"/www/wwwroot/movie/applications/index/view/dianka/index.html";i:1586957862;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
  ...
  <!--标题-->
       ...
       <div class="panel-heading">
            <?php if(session('power')=='1'){?>
				<li class="layui-nav-item  slide-sidebar" style="margin-bottom:10px">
